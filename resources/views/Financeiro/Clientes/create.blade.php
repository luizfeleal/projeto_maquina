...
<div class="cadastro-cliente-page">
    ...
    <form action="{{ route('financeiro-clientes-registrar') }}" id="cadastro-cliente-form" class="cadastro-cliente-grid needs-validation" method="post" enctype="multipart/form-data" novalidate>
        @csrf
...
<style>
    ...
    :root[data-theme="dark"] .cc-preview-produtos-total { color: #f3f4f6; }
