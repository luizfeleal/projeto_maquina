    ...
    <div class="col-12 col-lg-7">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom d-flex align-items-center gap-2 py-3">
                <iconify-icon icon="solar:pen-bold-duotone" style="font-size:1.4rem; color:#b45309;"></iconify-icon>
                <h5 class="mb-0 fw-semibold">Editar Produto do Estoque</h5>
            </div>
            <div class="card-body p-4 p-lg-5">

                <form action="{{ route('financeiro-estoque-atualizar', $produto['id']) }}"
                      method="POST"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="hidden" id="valor" name="valor" value="{{ old('valor', $produto['valor']) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('cobrar_mensal', $produto['cobrar_mensal']) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="{{ route('financeiro-estoque-detalhar', $produto['id']) }}" class="btn btn-outline-secondary">Cancelar</a>
