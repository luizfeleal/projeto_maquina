                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="cliente_celular" id="cliente_celular"
                               value="{{ $cliente['cliente_celular'] }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" name="cliente_email" id="cliente_email"
                               value="{{ $cliente['cliente_email'] }}" required>
                        <div class="invalid-feedback">
        ...
        <div style="background:#fff; border:1px solid #e8ecf0; border-radius:16px;
            ...
            <div style="padding:16px 20px; display:flex; flex-direction:column; gap:12px;">
                ...
                <div id="row-pagbank"
                     style="display:flex; align-items:center; justify-content:space-between; gap:8px;
                            padding:12px; border-radius:10px; border:1px solid #f3f4f6;
                            background:{{ $permissaoPagbank ? '#f0fdf4' : '#fff7f7' }};">
                    <div style="display:flex; align-items:center; gap:8px;">
                        <iconify-icon id="icon-pagbank" icon="solar:card-recive-bold-duotone"
                                      style="font-size:1.1rem; color:{{ $permissaoPagbank ? '#16a34a' : '#dc2626' }};"></iconify-icon>
                        <div>
                            <p style="margin:0; font-size:.85rem; font-weight:600; color:#374151;">Jogada Máquininha</p>
                            <p id="label-pagbank"
                               style="margin:0; font-size:.72rem; font-weight:700;
                                      color:{{ $permissaoPagbank ? '#16a34a' : '#dc2626' }};">
                                {{ $permissaoPagbank ? 'Liberado' : 'Bloqueado' }}
                            </p>
                        </div>
                    </div>
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" name="checkbox_pagbank" type="checkbox"
                               role="switch" id="checkboxPagbank" {{ $permissaoPagbank ? 'checked' : '' }}>
                    </div>
                </div>
            ...
            <div style="padding:0 20px 20px;">
                <button class="btn btn-primary w-100" type="submit">Atualizar usuário</button>
            </div>
        </div>
