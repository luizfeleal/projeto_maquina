...
@section('content')
        ...
        <div  class="usuarios div-center-column w-100"
            ...
            <div class="container section container-platform div-center-column"
                ...
                <form action="{{ route('credencial-atualizar', $credencial['id']) }}" id="editar-credencial-form"  class="w-100 needs-validation form-center"  method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
