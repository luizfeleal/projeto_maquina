        ...
        <div class="flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px; height: 100vh;display: flex;flex-direction: column;justify-content: space-around; position:fixed;min-height: 800px;">
            <div>
                ...
                <li class="mb-1">
                        ...
                        <div class="collapse {{$currentRoute === 'local-criar' || $currentRoute === 'local-incluir-usuario' ||$currentRoute === 'maquinas-criar' || $currentRoute === 'credencial-criar-pagbank' || $currentRoute === 'credencial-criar-efi' || $currentRoute === 'cliente-credencial-listar' || $currentRoute === 'cliente-maquinas-cartao' ? 'show' : '' }}" id="maquinas-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a href="{{route('cliente-credencial-listar')}}" class=" d-inline-flex text-decoration-none rounded" style="{{  $currentRoute === 'cliente-credencial-listar' ? 'color:grey !important;': ' ' }}">Editar credenciais</a></li>
                                <li><a href="{{route('cliente-maquinas-cartao')}}" class=" d-inline-flex text-decoration-none rounded" style="{{  $currentRoute === 'cliente-maquinas-cartao' ? 'color:grey !important;': ' ' }}">Incluir Máquina Cartão</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="mb-1">
