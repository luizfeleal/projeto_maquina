...
<head>
    ...
    <title>@yield('title') — SwiftPay Financeiro</title>
    ...
    @include('partials.pwa-head-financeiro')
...
<body>
    ...
    <div class="app-wrapper">
        ...
        @include('partials.sidebar-financeiro')
    ...
    @include('partials.bottom-bar-financeiro')
