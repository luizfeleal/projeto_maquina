...
<body>
    ...
    <script>
        ...
        // Qualquer data-bs-toggle="modal" que aponte para #ModalCenter*
        // é interceptado e substituído por um diálogo SweetAlert2.
        // Os divs .modal permanecem no DOM como "fonte de dados" mas
        // nunca são exibidos pelo Bootstrap.
        // =========================================================
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('[data-bs-toggle="modal"][data-bs-target]').forEach(function (trigger) {
                ...
                // Desliga o Bootstrap modal para este gatilho
                ...
                trigger.addEventListener('click', function (e) {
                    ...
                    // Executa o onclick original (ex: setIdLocalExcluir) para
                    // preencher inputs hidden antes de confirmar
                    if (originalOnclick) {
