                ...
                @if(session('imageQr'))
                    ...
                    <div id="imagem_qr" class="div-imagem-qr-index">
                        <div class="container">
                            ...
                            <a href="{{route('cliente-qr-download',  ['id_local'=> session('local')['id_local'], 'id_maquina' => session('maquina')['id_maquina']])}}" class="btn btn-primary"><i class="fa-solid fa-download"></i> Download</a>
                        </div>
                    </div>
