            ...
            <div class="container section container-platform div-center-column"
                ...
                <div class="collapse" id="collapseExample">
                    ...
                    <div class="form-check form-check-inline col-md-3">
                        <label for="input_data_inicio_filtro col-md-8">Local:</label>
                        <input type="date" name="input_data_inicio_filtro" id="input_filtro_local" class="form-control " data-column="0">
                    </div>
                    <div class="form-check form-check-inline col-md-3">
                        <label for="input_data_inicio_filtro col-md-8">Cliente:</label>
                        <input type="date" name="input_data_inicio_filtro" id="input_filtro_cliente" class="form-control " data-column="0">
                    </div>
                    <div class="form-check form-check-inline col-md-3">
                        <label for="input_data_inicio_filtro col-md-8">Máquina:</label>
                        <input type="date" name="input_data_inicio_filtro" id="input_filtro_maquina" class="form-control " data-column="0">
                    </div>
                </div>
</div>
