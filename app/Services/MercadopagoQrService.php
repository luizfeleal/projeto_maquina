...
class MercadopagoQrService
{
    public static function criar($dados)
    {
        ...
        return ApiClient::post('/mercadopagoQr', $payload);
    }
    ...
    {
        return self::normalizar(ApiClient::get('/mercadopagoQr', ['sem_imagem' => 1]), null);
    }

    public static function coletar(string $id = null)
    {
        $path = is_null($id) ? '/mercadopagoQr' : "/mercadopagoQr/{$id}";
    ...
    {
        $response = ApiClient::delete("/mercadopagoQr/{$id}");
